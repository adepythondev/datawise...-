...
# (str) Package name
package.name = datawiseapp

# (str) Package domain (needed for android/ios packaging)
package.domain = org.adepython
...
#       [app]
#       title = DataWise # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = DataWise
#          package.name = datawiseapp # This is all part of the title.
#
